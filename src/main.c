...
void drawShadow(Animal* A,int index){
    float light[3]={50.0f,100.0f,50.0f}; 
    float shadowMat[16] = {
        light[1],0,0,0,
        -light[0],0,-light[2],-1,
        0,0,light[1],0,
...
void keyboard(unsigned char key,int x,int y){
    ...
    switch(key){
        ...
        case '1': AudioServicesPlaySystemSound(animalSounds[0]); break; 
        case '2': AudioServicesPlaySystemSound(animalSounds[1]); break;
        case '3': AudioServicesPlaySystemSound(animalSounds[2]); break;
        case '4': AudioServicesPlaySystemSound(animalSounds[3]); break; 
        case '5': AudioServicesPlaySystemSound(animalSounds[4]); break;
    }
    glutPostRedisplay();
}
...
void specialKeys(int key,int x,int y){
    ...
    float rightZ = dirX;
    switch(key){
        case GLUT_KEY_LEFT:  camX -= rightX * camSpeed; camZ -= rightZ * camSpeed; break;  
        case GLUT_KEY_RIGHT: camX += rightX * camSpeed; camZ += rightZ * camSpeed; break; 
        case GLUT_KEY_UP:    camX += dirX * camSpeed;  camZ += dirZ * camSpeed; break;  
        case GLUT_KEY_DOWN:  camX -= dirX * camSpeed;  camZ -= dirZ * camSpeed; break;
    }
    glutPostRedisplay();
}
